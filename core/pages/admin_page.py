...
TASK_OPTIONS = ("None selected", "ambiguity_task", "example_task", "ambistory_task", "ambisentence_task", "eval_ambisentence_task", "ambistory2_task", "ending_task", "eval_ending_task", "big_ambisentence_task", "big_ending_task", "big_ending_task_round2", "big_eval_ending_task", "rewriting_judgement_task", "headline_rewriting_task")
