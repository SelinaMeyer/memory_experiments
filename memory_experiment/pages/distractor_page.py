...
def distraction():
    if time.time() - st.session_state.get("distractor_timer") < 15:
        st.image("memory_experiment/resources/cat_scale.webp", width=500)
        ...
        st.image("memory_experiment/resources/landscapes.png", width=500)
        ...
        st.image("memory_experiment/resources/hammerhead_shark.webp", width=500)
        ...
        st.image("memory_experiment/resources/night_out.png", width=500)
