...
""")
        ...
        if prolific_id and agree=="I have read and understood the information above and agree to participate in this experiment":
            ...
            if captcha_text:
                ...
                if captcha_text == st.session_state.captcha:
                    ...
                    st.switch_page("change_detection_task/pages/Experiment_description_page.py")
                else:
    ...
    if checkpoint[0] == 1:
        ...
        st.switch_page("change_detection_task/pages/recall_page.py")
    elif checkpoint[0] == 4:
        st.switch_page("change_detection_task/pages/recognition_page.py")
    elif checkpoint[0] == 5:
        st.switch_page("change_detection_task/pages/truthjudgement_page.py")
    elif checkpoint[0] == 6:
        st.switch_page("change_detection_task/pages/demographics_page.py")
    elif checkpoint[0] == 7:
