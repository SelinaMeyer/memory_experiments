...
with st.container(border=False, key="my_blue_container"):
        st.html("""<p><b><i>Wie funktioniert das Experiment?</i></b></p><p>Im Folgenden wirst du für jeweils 10 Sekunden 8 Nachrichtenüberschriften sehen, die du dir so gut wie möglich einprägen sollst. Im Anschluss wird deine Erinnerung getestet.</p>
