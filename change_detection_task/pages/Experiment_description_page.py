...
st.html("<p><b><i>Und wie ist das mit dem Gedächtnis gemeint?</i></b></p> <p>LLMs haben ein sogenanntes Context-Window. Das beschreibt die Menge an Text, die sie innerhalb einer Interaktion oder Unterhaltung miteinbeziehen können. Es ist also so etwas wie das \"Kurzzeitgedächtnis\" von LLMs.</p><p>Aber LLMs können beim Abruf von Informationen Fehler machen, selbst wenn sie innerhalb des Context-Windows lagen. Das kann zum Beispiel passieren, wenn eine Interaktion länger dauert und somit mehr Inhalt im \"Kurzzeitgedächtnis\" des LLMs gespeichert werden muss.</p>")
