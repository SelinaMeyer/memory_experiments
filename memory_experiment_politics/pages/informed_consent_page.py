...
<p>Your participation in this online study is completely voluntary. You will be one of approximately 120 people being surveyed for this research. You will receive 4.6 GBP as compensation for your participation. 
...
""")
        ...
        if prolific_id and agree=="I have read and understood the information above and agree to participate in this experiment":
            ...
            if captcha_text:
                ...
                if captcha_text == st.session_state.captcha:
                    ...
                    st.switch_page("memory_experiment_politics/pages/Experiment_description_page.py")
                else:
    ...
    print(checkpoint)
    if checkpoint[0] == 1:
        st.switch_page("memory_experiment_politics/pages/presentation_page.py")
    elif checkpoint[0] == 2:
        st.switch_page("memory_experiment_politics/pages/distractor_page.py")
    elif checkpoint[0] == 3:
        st.switch_page("memory_experiment_politics/pages/recall_page.py")
    elif checkpoint[0] == 4:
        st.switch_page("memory_experiment_politics/pages/recognition_page.py")
    elif checkpoint[0] == 5:
        st.switch_page("memory_experiment_politics/pages/truthjudgement_page.py")
    elif checkpoint[0] == 6:
        st.switch_page("memory_experiment_politics/pages/demographics_page.py")
    elif checkpoint[0] == 7:
        st.switch_page("memory_experiment_politics/pages/thank_you_page.py")
