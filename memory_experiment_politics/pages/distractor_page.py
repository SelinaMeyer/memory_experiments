...
def distraction():
    if time.time() - st.session_state.get("distractor_timer") < 15:
        st.image("memory_experiment_politics/resources/cat_scale.webp", width=500)
        ...
        st.image("memory_experiment_politics/resources/landscapes.png", width=500)
        ...
        st.image("memory_experiment_politics/resources/hammerhead_shark.webp", width=500)
        ...
        st.image("memory_experiment_politics/resources/night_out.png", width=500)
